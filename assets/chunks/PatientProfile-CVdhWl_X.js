...
import { al as ProgramService, _ as _export_sfc, P as PatientService, am as PatientProgramService, ad as GlobalPropertyService, r as StandardModal, o as createModal, an as _sfc_main$5, ao as ArtTasks, u as useDemographicsStore, F as DynamicButton, K as ObservationService, b as EncounterTypeId, G as toastSuccess, H as HisDate, ap as router, a as useProgramStore, h as useWindowSize, T as Toolbar, M as ProgramId, S as Service, aq as iconBMI, k as alertConfirmation, ar as openVisit, q as usePatientList, v as closeVisit, t as toastWarning, as as SetProgramService, N as ConceptService, at as getActiveVisit } from '../index-CXPpVy8J.js';
import { u as useUserActivities } from './useUserActivities-Drmk-hnT.js';
import { u as usePatientProfile } from './usePatientProfile-DJqQs_9Q.js';
import { D as DemographicBar } from './DemographicBar-DGQtw_tj.js';
import { i as isTaskPermitted } from './tasks-Ct0m_Qaz.js';
import { E as EnrollmentService, A as ANCRedirection } from './anc_service-N03vCWG9.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-Cbemqtyv.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BLDLvXIe.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BNEhI_ye.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-B67005Ne.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-CweWpKVL.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-uYjGrJ1V.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-DGEu0Kcu.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-CcjV-hEp.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-_yLg3FK0.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-BwjwOMNr.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-BBTvn9NE.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-CXPpVy8J.js').then(n => n.cV),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-Sp5J5Zwv.js'),true              ?[]:void 0));
    const router = useRouter();
