...
import { al as ProgramService, _ as _export_sfc, P as PatientService, am as PatientProgramService, ad as GlobalPropertyService, r as StandardModal, o as createModal, an as _sfc_main$5, ao as ArtTasks, u as useDemographicsStore, F as DynamicButton, K as ObservationService, b as EncounterTypeId, G as toastSuccess, H as HisDate, ap as router, a as useProgramStore, h as useWindowSize, T as Toolbar, M as ProgramId, S as Service, aq as iconBMI, k as alertConfirmation, ar as openVisit, q as usePatientList, v as closeVisit, t as toastWarning, as as SetProgramService, N as ConceptService, at as getActiveVisit } from '../index-CHDZB83z.js';
import { u as useUserActivities } from './useUserActivities-jgO5qfkj.js';
import { u as usePatientProfile } from './usePatientProfile-Cy9YzNTA.js';
import { D as DemographicBar } from './DemographicBar-Dk5HZCfz.js';
import { i as isTaskPermitted } from './tasks-B-jQpKmE.js';
import { E as EnrollmentService, A as ANCRedirection } from './anc_service-CKJ7Zpj8.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-BHLd8g_B.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-Ba8aTeED.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-BhAXlAcq.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-B9vk4u7t.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-B5Xz5j9S.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-oe_ErH7O.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-CfLAGYgw.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-D-IhZ6-u.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-DGNuEgj0.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-DJuusgly.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-CMth4Qtk.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-CHDZB83z.js').then(n => n.cV),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-Bm0InduI.js'),true              ?[]:void 0));
    const router = useRouter();
