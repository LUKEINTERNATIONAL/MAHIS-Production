...
import { al as ProgramService, _ as _export_sfc, P as PatientService, am as PatientProgramService, ad as GlobalPropertyService, r as StandardModal, o as createModal, an as _sfc_main$5, ao as ArtTasks, u as useDemographicsStore, F as DynamicButton, K as ObservationService, b as EncounterTypeId, G as toastSuccess, H as HisDate, ap as router, a as useProgramStore, h as useWindowSize, T as Toolbar, M as ProgramId, S as Service, aq as iconBMI, k as alertConfirmation, ar as openVisit, q as usePatientList, v as closeVisit, t as toastWarning, as as SetProgramService, N as ConceptService, at as getActiveVisit } from '../index-IxV04vBF.js';
import { u as useUserActivities } from './useUserActivities-DKS8O9ki.js';
import { u as usePatientProfile } from './usePatientProfile-KTGpwFWx.js';
import { D as DemographicBar } from './DemographicBar-CC5fAM5J.js';
import { i as isTaskPermitted } from './tasks-lT5LEjdn.js';
import { E as EnrollmentService, A as ANCRedirection } from './anc_service-BovJaNZH.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-mX-aPfBM.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-B30N2rg7.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CQUPHhCp.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-2Nuj9jvz.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-BAhUvzu9.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-IsNz-8eW.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-u2mY-GQE.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-C7eGlYzh.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-DrR4i7-V.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-CyBQ6Zvw.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-NtXEaKYU.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-IxV04vBF.js').then(n => n.cV),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-ByjleQYC.js'),true              ?[]:void 0));
    const router = useRouter();
