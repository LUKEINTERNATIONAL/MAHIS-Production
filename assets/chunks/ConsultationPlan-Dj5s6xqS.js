...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, M as ConceptService, H as HisDate, _ as _export_sfc, bo as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b2 as useTreatmentPlanStore, F as DynamicButton, a1 as DrugService, b4 as confirmModal, b3 as useOutcomeStore, aC as ListPicker, bj as useInvestigationStore, bZ as useOPDDiagnosisStore, e as useGeneralStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, bl as getOfflineSavedUnsavedData, J as savePatientRecord, b_ as resetOPDPatientData, bJ as StagesService, q as usePatientList, v as closeVisit } from '../index-uj3ZKM65.js';
import { D as DemographicBar } from './DemographicBar-YJmkOQpe.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-DLnHicvY.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-bjg3AKLD.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-B8xd1MxO.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-wYDpFiIL.js';
import { I as Investigations } from './Investigations-Z6Er4tAO.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-Ch-lhDKd.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-BOlVlM-9.js';
import { P as PreviousTreatment } from './treatment-CVqVMUYO.js';
import { l as lodashExports } from './lodash-CMC_Grj0.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-DsuYIK8z.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CfzVbjw2.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-CzHDdtNQ.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-CwQalBuk.js';
