...
import { S as SummarySection } from './SummarySection-DV7jLvH7.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function getOfflineBirthWeightInGrams(patientId) {
      try {
        ...
        const { default: NeonatalOfflineService } = await __vitePreload(async () => { const { default: NeonatalOfflineService } = await import('./neonatal_offline_service-la2_v1gh.js');return { default: NeonatalOfflineService }},true              ?[]:void 0);
