...
import { al as ProgramService, _ as _export_sfc, P as PatientService, am as PatientProgramService, ad as GlobalPropertyService, r as StandardModal, o as createModal, an as _sfc_main$5, ao as ArtTasks, u as useDemographicsStore, F as DynamicButton, K as ObservationService, b as EncounterTypeId, G as toastSuccess, H as HisDate, ap as router, a as useProgramStore, h as useWindowSize, T as Toolbar, M as ProgramId, S as Service, aq as iconBMI, k as alertConfirmation, ar as openVisit, q as usePatientList, v as closeVisit, t as toastWarning, as as SetProgramService, N as ConceptService, at as getActiveVisit } from '../index-CF5eLaTi.js';
import { u as useUserActivities } from './useUserActivities-CzcLg8LO.js';
import { u as usePatientProfile } from './usePatientProfile-gENrckgN.js';
import { D as DemographicBar } from './DemographicBar-D67QTr0q.js';
import { i as isTaskPermitted } from './tasks-ClsU62-9.js';
import { E as EnrollmentService, A as ANCRedirection } from './anc_service-DrWPwZy6.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    const LabOrdersList = defineAsyncComponent(() => __vitePreload(() => import('./LabOrdersList-Dh6EO2jd.js'),true              ?[]:void 0));
    const DiagnosesHistory = defineAsyncComponent(() => __vitePreload(() => import('./DiagnosesHistory-BdVbj9g_.js'),true              ?[]:void 0));
    const AllergiesHistory = defineAsyncComponent(() => __vitePreload(() => import('./AllergiesHistory-CpJxgGya.js'),true              ?[]:void 0));
    const MedicationsHistory = defineAsyncComponent(() => __vitePreload(() => import('./MedicationsHistory-O8Gl3DsC.js'),true              ?[]:void 0));
    const VisitsHistory = defineAsyncComponent(() => __vitePreload(() => import('./VisitsHistory-D9NzkHL6.js'),true              ?[]:void 0));
    const VitalsMeasurementsSummary = defineAsyncComponent(() => __vitePreload(() => import('./VitalsMeasurementsSummary-Bc9gh-On.js'),true              ?[]:void 0));
    const PatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./PatientProfile-0H0lJQys.js'),true              ?[]:void 0));
    const HTSPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./HTSPatientProfile-C8iHHnQB.js'),true              ?[]:void 0));
    const NeonatalPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./NeonatalPatientProfile-CzYKCcJI.js'),true              ?[]:void 0));
    const AETCPatientProfile = defineAsyncComponent(() => __vitePreload(() => import('./AETCPatientProfile-Cug1tkZI.js'),true              ?[]:void 0));
    const WeightHeightChart = defineAsyncComponent(() => __vitePreload(() => import('./WeightHeightChart-CYU-TPle.js'),true              ?[]:void 0));
    const PreviousVitals = defineAsyncComponent(() => __vitePreload(() => import('../index-CF5eLaTi.js').then(n => n.cV),true              ?[]:void 0));
    const BloodPressure = defineAsyncComponent(() => __vitePreload(() => import('./BloodPressure-DKBEa9Hd.js'),true              ?[]:void 0));
    const router = useRouter();
