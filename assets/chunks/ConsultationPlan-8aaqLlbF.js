...
import { u as useDemographicsStore, K as ObservationService, b as EncounterTypeId, N as ConceptService, H as HisDate, _ as _export_sfc, bp as useAllegyStore, n as icons, o as createModal, z as StandardForm, t as toastWarning, G as toastSuccess, P as PatientService, S as Service, b4 as useTreatmentPlanStore, F as DynamicButton, a2 as DrugService, b6 as confirmModal, b5 as useOutcomeStore, aD as ListPicker, bl as useInvestigationStore, b_ as useOPDDiagnosisStore, e as useGeneralStore, b3 as useVitalsStore, bH as useNextAppointmentStore, T as Toolbar, s as isPatientDeceased, x as toastDanger, a$ as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bK as StagesService, q as usePatientList, v as closeVisit } from '../index-DjGaZTxs.js';
import { D as DemographicBar } from './DemographicBar-Bw1-DwJG.js';
import { e as eyeOpeningMinorWeights, a as eyeOpeningWeights, m as motorResponseMinorWeights, b as motorResponseWeights, v as verbalResponseMinorWeights, c as verbalResponseWeights, _ as _sfc_main$7 } from './LevelOfConsciousness.vue_vue_type_script_setup_true_lang-BxP6EboR.js';
import { P as PresentingComplaints, _ as _sfc_main$8, a as _sfc_main$9 } from './PresentingComplaints-BYaKEtVu.js';
import { S as SelectTestDateModal } from './SelectTestDateModal-C4D5a25U.js';
import { A as Allergies, D as DynamicList, N as NonPharmacologicalIntervention, p as patientSessionManager, a as NextAppointment } from './ClientUtils-Dzr6N-MN.js';
import { I as Investigations } from './Investigations-C1AjarZO.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-SVAtIaXS.js';
import { a as DRUG_FREQUENCIES, b as getDrugRouteList } from './drug_prescription_service-BvvgSaEa.js';
import { P as PreviousTreatment } from './treatment-C7WoJpWz.js';
import { l as lodashExports } from './lodash-BEEU-9Fk.js';
import { D as DynamicDispositionList, A as AdmittedforShortStayOutcomef, R as ReferredOutCome, b as DischargedHome, d as deadOutcome, c as ReferToAnotherClinic, u as usePatientProfile } from './usePatientProfile-zhLNbwD_.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-TL2pRZEk.js';
import { a as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-HVaFiOM5.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-DM-KsRdQ.js';
