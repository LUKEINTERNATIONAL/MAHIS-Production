...
import { u as useDemographicsStore, bb as useInvestigationStore, bW as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-Df-IzsWi.js';
import { D as DemographicBar } from './DemographicBar-8vp_Tdco.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-BCIBoEcF.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-D1vKwXGr.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-BmR0_H3z.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-Bjwul--I.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-BFrXD0Es.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-Dc-Ol7qd.js';
