...
import { S as SummarySection } from './SummarySection-C-eF1IYf.js';
  ...
  setup(__props, { expose: __expose }) {
    ...
    async function getOfflineBirthWeightInGrams(patientId) {
      try {
        ...
        const { default: NeonatalOfflineService } = await __vitePreload(async () => { const { default: NeonatalOfflineService } = await import('./neonatal_offline_service-BZ_iRUx6.js');return { default: NeonatalOfflineService }},true              ?[]:void 0);
