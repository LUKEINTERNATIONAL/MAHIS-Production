...
import { u as useDemographicsStore, bb as useInvestigationStore, bW as useOPDDiagnosisStore, b2 as useTreatmentPlanStore, e as useGeneralStore, b3 as useOutcomeStore, b1 as useVitalsStore, bG as useNextAppointmentStore, T as Toolbar, F as DynamicButton, s as isPatientDeceased, G as toastSuccess, x as toastDanger, K as ObservationService, b as EncounterTypeId, H as HisDate, b5 as getOfflineSavedUnsavedData, J as savePatientRecord, b$ as resetOPDPatientData, bJ as StagesService, v as usePatientList, t as toastWarning, r as closeVisit, _ as _export_sfc } from '../index-D10KSjsh.js';
import { D as DemographicBar } from './DemographicBar-CX928LnC.js';
import { C as ClinicalAssessment, b as OPDTreatmentPlan, O as OPDOutcome } from './OPDOutcome-DlwFnvQl.js';
import { I as Investigations, N as NextAppointment } from './NextAppointment-Cf79Z_et.js';
import { O as OPDDiagnosis } from './OPDDiagnosis-C50bjcef.js';
import { O as OPDPrintingModal } from './OPDPrintingModal-CjixUjze.js';
import { b as createOPDDrugOrder, u as useNonPharmaTherapyStore } from './nonPharmaTherapyStore-BQ3DJaxP.js';
import { u as usePresentingComplaintsStore } from './previousComplaints-C8ehEXM2.js';
