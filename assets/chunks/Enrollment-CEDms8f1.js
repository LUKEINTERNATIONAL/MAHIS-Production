  ...
  setup(__props, { expose: __expose }) {
    ...
    async function getOfflineBirthWeightInGrams(patientId) {
      try {
        ...
        const { default: NeonatalOfflineService } = await __vitePreload(async () => { const { default: NeonatalOfflineService } = await import('./neonatal_offline_service-WtznPvQe.js');return { default: NeonatalOfflineService }},true              ?[]:void 0);
